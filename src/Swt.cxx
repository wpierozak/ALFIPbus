...
Swt stringToSwt(const char* str)
{
    ...
    frame.data = (static_cast<uint32_t>(stringToByte(str[11], str[12])) << 24) 
                + (static_cast<uint32_t>(stringToByte(str[13], str[14])) << 16) 
                + (static_cast<uint32_t>(stringToByte(str[15], str[16])) << 8) 
                + static_cast<uint32_t>(stringToByte(str[17], str[18]));

    frame.address = (static_cast<uint32_t>(stringToByte(str[3], str[4])) << 24) 
                + (static_cast<uint32_t>(stringToByte(str[5], str[6])) << 16) 
                + (static_cast<uint32_t>(stringToByte(str[7], str[8])) << 8) 
                + static_cast<uint32_t>(stringToByte(str[9], str[10]));
